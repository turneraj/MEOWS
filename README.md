...
**Before starting the example, please download the `meows` directory (folder) and save it to your computer. Within the same directory, you should have [manually placed] your `MUSCLE executable file` and `RAxML executable file`.**
